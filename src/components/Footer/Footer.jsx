    ...
    <div style={{ width: "100%", margin: "auto" }}>
      <Stack color={"white"} bg={"black"} width={"100%"} margin={"auto"}>
        <Box display={"flex"} gap="20px" w={"100%"}>
          ...
          <Link>
            <Text>Intrest-Based Advertising</Text>
          </Link>
          <Link>
            <Text>Anti Discrimination Policy</Text>
          </Link>
          <Link>
            <Text>Partner Welfare Policy</Text>
          </Link>
        </Box>
        ...
        <Divider />
        <Box textAlign={"left"}>
          <Text fontWeight={"bold"} fontSize={"1xl"} marginTop="20px">
            Serving In
          </Text>
        </Box>
        ...
        <Box>
          <Text textAlign={"left"} fontWeight={"bold"} marginTop="20px">
            IND
          </Text>
        </Box>
        <Box display={"flex"} gap="30px">
          ...
          <div className="copyRightContainer">
            <div className="copyRight">
              <span style={{ position: "relative", left: "0px" }}>
                © 2014-20 Company Technologies India Pvt. Ltd.
              </span>
            </div>
